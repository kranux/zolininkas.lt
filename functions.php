<?php
  ...
  if (function_exists('register_sidebar')) {
      ...
      register_sidebar(array('name' => 'Index page widgetsbar', 'before_widget' => '<div id="%1$s" class="%2$s">', 'after_widget' => '</div>', 'before_title' => '<h4>', 'after_title' => '</h4>', ));
  }
...
function get_main_image($content){
